...
public class tabung extends LKBangun3D {
    ...
    public void setJarijr() {
        System.out.println("Kamu Memilih Tabung");
    ...
    public void infoBangun(){
        System.out.println("Jika tabung memiliki jari-jari = " + getJarijr() +", dan tinggi " + getTinggi());
    }
    
    @Override
    public void hitungVolume(){
        volume = 3.14 * jarijr * jarijr * tinggi;
        super.hitungVolume();
    }    
}
