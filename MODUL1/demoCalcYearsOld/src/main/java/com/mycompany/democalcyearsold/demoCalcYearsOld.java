...
package com.mycompany.democalcyearsold;
...
public class demoCalcYearsOld { //kelas utama
    ...
    public static void main(String[] args) { //method main digunakan untuk menjalankan program.
        ...
        dengan tanggal 1 Januari pada tahun sekarang. */
        // Dari selisih tersebut program menggunakan method getYears untuk mendapatkan nilai umur dalam tahun.
